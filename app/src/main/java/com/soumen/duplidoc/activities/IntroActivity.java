...
import com.soumen.duplidoc.adapters.IntroPagerAdapter;
...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myViewPagerAdapter = new IntroPagerAdapter(IntroActivity.this, layouts);
    ...
    private void launchHomeScreen() {
        startActivity(new Intent(IntroActivity.this, LockSetterActivity.class));
        finish();
    }
