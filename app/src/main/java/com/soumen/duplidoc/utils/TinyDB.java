...
public class TinyDB {
     ...
     * @param key int value returned if key was not found
     ...
     * @param key SharedPreferences key
     * @param key float value returned if key was not found
     ...
     * @param key SharedPreferences key
     * @param key boolean value returned if key was not found
